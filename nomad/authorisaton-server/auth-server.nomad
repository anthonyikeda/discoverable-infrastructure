  ...
  group "cache" {
    ...
    task "authserver" {
      ...
      env {
        ...
        SPRING_CLOUD_VAULT_APP_ROLE_ROLE_ID = "44b968da-a430-620c-d702-b8270feb4a06"
        SPRING_CLOUD_VAULT_APP_ROLE_SECRET_ID = "b1cd46bb-540c-0ed7-1bc7-5c8bea0fd50f"
