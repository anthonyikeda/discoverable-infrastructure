  ...
  group "cache" {
    ...
    task "employee-api" {
      ...
      env {
        ...
        SPRING_CLOUD_VAULT_AUTHENTICATION = "APPROLE"
        SPRING_CLOUD_VAULT_APP_ROLE_ROLE_ID = "b26f2000-a623-0755-0351-1849717bb764"
        SPRING_CLOUD_VAULT_APP_ROLE_SECRET_ID = "971f7d58-131b-d248-6583-e425c6701f23"
      ...
      config {
        image = "anthonyikeda/employee-api:1.0.0"
        port_map {
          http = 8081
        }
        network_mode = "host"
